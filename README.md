...
- 🌐 **Двуязычность и автоперевод**: поддержка русского и английского языков (интерфейс и автоматический перевод названий и описаний снимков NASA с кэшированием).
...
- **[aiohttp](https://github.com/aio-libs/aiohttp)** — асинхронные HTTP-запросы к NASA API и переводчику
...
├── translator.py         # Асинхронный переводчик контента NASA с кэшированием
